  ...
  ngOnInit() {
    this.homePageServices = [
      ...
      },
      {
        ...
        description:
          "Learn how a purpose-driven strategy is about doing the right thing for customers and society--and also a powerful way to drive growth.",
      },
      {
        imgName: "ai",
        ...
        description:
          "Professionalize your approach to AI to change what’s possible for your business.",
      },
      {
        imgName: "business",
